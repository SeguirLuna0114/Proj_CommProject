	...
	<div id="mp_wrap">
				...
				<div class="mp_account">
					...
					<div class="cp_menu">
						<select name="cp_option" id="cp_option_select" onchange="changePage()">
							...
							<option value="recruitStatus_main" selected="selected">작성 공고 관리</option>
						</select>
					</div>
				</div>
		...
		<div class="cp_contents">
			<div class="cp_applications">
				<a href="writeJobStatusAll.do?id=${principal.id}" class="cp_apply_manage">
				...
				<div class="cp_content_wrapper">
					...
					<div class="paging">
						<ul class="pagination">
							<li class="page-item-prev${pagingWantedsManage.pagingDto.first ? &quot;hidden&quot; : &quot;&quot;}"><a
								href="mypage_JobBoard.do?id=${id}&page=${pagingWantedsManage.pagingDto.currentPage - 1}">이전</a></li>
							<c:forEach var="num" begin="${pagingWantedsManage.pagingDto.startPageNum}" end="${pagingWantedsManage.pagingDto.lastPageNum}">
								<li class="page-item${pagingWantedsManage.pagingDto.currentPage + 1 == num ? &quot;-select&quot; : &quot;&quot;}"><a
									href="mypage_JobBoard.do?id=${id}&page=${num-1}">${num}</a></li>
							</c:forEach>
							<li class="page-item-next${pagingWantedsManage.pagingDto.last ? &quot;-hidden&quot; : &quot;&quot;}"><a
								href="mypage_JobBoard.do?id=${id}&page=${pagingWantedsManage.pagingDto.currentPage + 1}">다음</a></li>
						</ul>
					</div>
				</div>
			</div>
