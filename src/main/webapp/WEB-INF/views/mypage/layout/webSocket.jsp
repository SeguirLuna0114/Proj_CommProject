...
<script src="https://code.jquery.com/jquery-3.6.4.min.js"
	integrity="sha256-oP6HI/t1fWCfW8fEwiHNgsVtLkPnhGwqcx5x0YcGepE="
...
<script type="text/javascript">
	...
	function connect() {
		...
		stompClient.connect({}, function(frame) {
			...
			// 구인공고 지원자 수 알림
			stompClient.subscribe("/topic/application-notifications",
					function() {
			...
			// 개인 메시지
			stompClient.subscribe("/user/topic/private-notifications",
					function(message) {
						headerAlarmCnt = headerAlarmCnt + 1;
						updateHeaderNotificationDisplay();
					});
