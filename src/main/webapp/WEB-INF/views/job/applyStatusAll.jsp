...
<div id="wrap">
	<div id="asa_wrap">
		<div class="asa_menu">
			...
			<ul>
				<li class="asa_position"><a href="applyStatusAll.do?id=${principal.id}">지원 현황</a></li>
				<li class="asa_proposal"><a href="writeJobStatusAll.do?id=${principal.id}">구인 현황</a></li>
			</ul>
		</div>
		...
		<div class="asa_contents">
			...
			<div class="asa_search">
				<form name="searchAll" action="applyStatusAll.do?id=${statusAllDto.id}">
				...
				<table class="asa_table">
					...
					<tbody>
						<c:forEach var="statusInfoDtos" items="${statusAllDto.statusInfoDtos}">
							<tr>
								<td><a href="#">${statusInfoDtos.jobSub}</a></td>
								<td>${statusInfoDtos.jobCd}</td>
								<td>${statusInfoDtos.jobEndDate}</td>
								<td>
									<c:choose>
